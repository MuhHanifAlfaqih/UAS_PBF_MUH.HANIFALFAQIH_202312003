...
├── prisma/
│   ├── migrations/
│   │   └── (hasil migrate Prisma)
│   ├── schema.prisma
│
├── views/
│   ├── aktivitas/
│   │   ├── index.ejs        # Halaman master / daftar aktivitas
│   │   ├── tambah.ejs       # Form tambah aktivitas
│   │   └── edit.ejs         # Form edit aktivitas
│   │
│   ├── detail/
│   │   ├── index.ejs        # Halaman detail aktivitas (master–detail)
│   │   ├── tambah.ejs       # Form tambah detail aktivitas
│   │   └── edit.ejs         # Form edit detail aktivitas
│   │
...
│   └── js/
│       └── script.js        # (Opsional) JS tambahan
│
├── prisma/
│   └── client.js            # Prisma Client
│
├── app.js                   # File utama Express
├── .env                     # Konfigurasi environment (DB, session)
├── package.json
├── package-lock.json
├── README.md
└── node_modules/
